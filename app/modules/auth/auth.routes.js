...
router.patch("/update/:id" , AuthGuard , expressAsyncHandler(authController.updateProfile));
router.patch("/update-avatar/:id" , AuthGuard , uploadFile.single("avatar") , expressAsyncHandler(authController.updateAvatar));
